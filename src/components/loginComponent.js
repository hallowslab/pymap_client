...
import { Button, Card, CardActions, CardContent, FormControl, Container, InputLabel, OutlinedInput, InputAdornment, IconButton } from '@mui/material'
...
export default function LoginForm(props) {
    ...
    const handleCall = () => {
        ...
        if (user == "" || password == "") {
            alert("Your input seems to be invalid, please check the console log")
